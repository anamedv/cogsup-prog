...
mapped_list = [responses_mapping[char] for char in responses]
print(mapped_list)
...
sorted_keys_dct = {k: animals[k] for k in sorted(animals)}
print(sorted_keys_dct)
...
sorted_values_dct = dict(sorted(animals.items(), key=lambda item: item[1]))
